...
/**
 * A wizard page that displays the list of public methods on the currently
 * selected class so that the user can select or deselect them before creating a
 * new test class.
 * 
...
public class TestNGMethodWizardPage extends WizardPage {
  ...
  public void createControl(Composite parent) {
    ...
    {
      m_table = new Table(container, SWT.CHECK | SWT.BORDER | SWT.V_SCROLL
          | SWT.H_SCROLL);

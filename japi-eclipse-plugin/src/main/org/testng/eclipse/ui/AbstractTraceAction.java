...
/**
 * Used by TraceCopyAction and MessageCopyAction to copy the failure trace, or
 * only its first line, to the clipboard.
 */
public abstract class AbstractTraceAction extends SelectionListenerAction {
   ...
   * @param clipboard
   */
  public AbstractTraceAction(FailureTrace view, Clipboard clipboard,
      String title) {
    super(title);

...
public class JUnitConverterQuickAssistProcessor extends
    BaseQuickAssistProcessor implements IQuickAssistProcessor {

  /**
   * This method needs to return fast since the QuickAssist pop up is waiting on
   * it.
   */
  public boolean hasAssists(IInvocationContext context) throws CoreException {
    ...
    // Nothing in the imports, try to make a guess based on the class name and
    // superclass
  ...
  public IJavaCompletionProposal[] getAssists(IInvocationContext context,
    ...
    if (hasAssists(context)) {
      ...
      for (int i = 0; i < providers.length; i++) {
        ...
        vResult.add(new JUnitRewriteCorrectionProposal(providers[i].getName(),
            cu, rewriter, 1));
      }
    }

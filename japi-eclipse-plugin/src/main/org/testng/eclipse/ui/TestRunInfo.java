...
public class TestRunInfo {
  ...
  private static class TestKey {
    ...
    /**
     * Returns <code>true</code> if this <code>TestKey</code> is the same as the
     * o argument.
     * 
     * @return <code>true</code> if this <code>TestKey</code> is the same as the
     *         o argument.
     */
    public boolean equals(Object o) {
      ...
      return (((this.m_className == null) ? (castedObj.m_className == null)
          : this.m_className.equals(castedObj.m_className)) && ((this.m_methodName == null) ? (castedObj.m_methodName == null)
    ...
    public int hashCode() {
      ...
      hashCode = (31 * hashCode)
          + ((m_methodName == null) ? 0 : m_methodName.hashCode());

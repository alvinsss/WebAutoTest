...
public class CompareResultDialog extends Dialog {
  ...
  static String[] regexes = { ".*expected:<(.*)> but was:<(.*)>.*",
  ...
  private void initializeActualExpected(String trace) {
    if (trace.indexOf("hamcrest") > 0)
      parseHamCrestTrace(trace);
    else
  ...
  protected void createButtonsForButtonBar(Composite parent) {
    createButton(parent, IDialogConstants.OK_ID,
        ResourceUtil.getString("CompareResultDialog.labelOK"), true); //$NON-NLS-1$
  }
  ...
  private Control createPreviewer(Composite parent) {
    ...
    compareConfiguration.setLeftLabel(ResourceUtil
        .getString("CompareResultDialog.expectedLabel")); //$NON-NLS-1$
    compareConfiguration.setLeftEditable(false);
    compareConfiguration.setRightLabel(ResourceUtil
        .getString("CompareResultDialog.actualLabel")); //$NON-NLS-1$
  ...
  public static class CompareResultViewerConfiguration extends
    ...
    public static class SimpleDamagerRepairer implements IPresentationDamager,
      ...
      public void createPresentation(TextPresentation presentation,
        ...
        presentation.addStyleRange(new StyleRange(prefix, fDocument.getLength()
            - suffix - prefix, attr.getForeground(), attr.getBackground(), attr
            .getStyle()));
      }
    }
  }

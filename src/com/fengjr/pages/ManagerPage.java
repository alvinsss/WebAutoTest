...
//		this.goTo();
	...
	// 结算审核
	By managerMainListSettledAuditBtn =  By.xpath("/html/body/div[3]/div[2]/ul/li[4]/ul/li[7]/a");
	
	public WebElement getmanagerMainListSettledAuditBtnFied(){
		return this.driver.findElement(managerMainListSettledAuditBtn);
	}
...
//	By managerLoanAuditSearchText = By.xpath("//div[@id='page-content']/div[@class='row-fluid']/div[@class='widget-box transparent span12']/div[@id='loanList_wrapper']/div[1]/div[@class='span6']/div[@id='loanList_filter']");
	...
	/***********************结算审核页面 *****************************************/
	// 满标审核
	By managerSettledAuditFullBtn = By.xpath("/html/body/div[3]/div[3]/div[2]/div[2]/ul/li[1]/a");
	
	public WebElement getmanagerSettledAuditFullBtnFied(){
		return this.driver.findElement(managerSettledAuditFullBtn);
	}

	// 流标处理
	By managerSettledAuditNotFullBtn = By.xpath("/html/body/div[3]/div[3]/div[2]/div[2]/ul/li[1]/a");
	
	public WebElement getmanagerSettledAuditNotFullBtnFied(){
		return this.driver.findElement(managerSettledAuditNotFullBtn);
	}

	// 满标列表的第1个结标审核按钮
	By managerSettledAuditFirstLoanBtn = By.xpath("/html/body/div[3]/div[3]/div[2]/div[2]/div/div[1]/div[3]/div/div[2]/div[2]/a");
//	By managerSettledAuditLoanLink = By.cssSelector("a[href=\"loan/settle/EE7BD309-B9B2-4225-9428-78D8FF34EF9E\"]");
	public WebElement getmanagerSettledAuditFirstLoanBtnFied(){
		return this.driver.findElement(managerSettledAuditFirstLoanBtn);
	}

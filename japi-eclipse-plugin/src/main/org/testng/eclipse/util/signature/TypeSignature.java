...
public class TypeSignature {
  ...
  /**
   * Make sure that this signature matches the string returned by
   * IMethod#getSignature or bugs like this one will happen:
   * http://groups.google
   * .com/group/testng-users/browse_thread/thread/50db1c6deb2ff48e
   * /60b80ac1999394f2?hl=en&lnk=gst&q=lisak#60b80ac1999394f2
   */

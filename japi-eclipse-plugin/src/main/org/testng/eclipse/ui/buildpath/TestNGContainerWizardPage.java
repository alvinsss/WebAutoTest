...
public class TestNGContainerWizardPage extends WizardPage implements
  ...
  public TestNGContainerWizardPage() {
    ...
    setDescription(ResourceUtil
        .getString("TestNGContainerWizardPage.description")); //$NON-NLS-1$
    setImageDescriptor(TestNGPlugin
        .getImageDescriptor("wizban/addlibrary_wiz.png")); //$NON-NLS-1$
  }
  ...
  public void createControl(Composite parent) {
    ...
    new Label(container, SWT.NONE).setText(ResourceUtil
        .getString("TestNGContainerWizardPage.message")); //$NON-NLS-1$

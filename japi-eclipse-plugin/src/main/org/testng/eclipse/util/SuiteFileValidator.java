...
public class SuiteFileValidator {
  private static final SAXParserFactory SAX_FACTORY = SAXParserFactory
      .newInstance();
  ...
  public static boolean isSuiteDefinition(IFile file, boolean xmlOnly)
  ...
  /**
   * @return true if the InputStream represents a TestNG definition file. For
   *         speed reasons, we stop the search as soon as we find an XML tag. If
   *         it's <suite>, return true, otherwise, return false (we also dodge

...
/**
 * An AST visitor to collect all the groups defined in a compilation unit. This
 * visitor extends JavaDocVisitor so it's able to visit both annotations and
 * javadoc annotations, so maybe it should actually be renamed.
 * 
 * @author cbeust
 */

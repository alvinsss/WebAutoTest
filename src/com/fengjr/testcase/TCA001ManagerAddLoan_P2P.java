 ...
 * repmentType:默认值：0【MonthlyInterest按月付息到期还本】,1 按月付息到期还本 , 2【EqualInstallment按月等额本息】, 
 * 3按月等额本金 ,  4【BulletRepayment 一次性还本付息】 ,5月平息 , 6按年付息到期还本  ,
 *
 * @author alvin
 * @version 1.0   
 * @since JDK 1.7
...
public class TCA001ManagerAddLoan_P2P {
	String test;
	WebDriver driver;
	
	Properties testdataconfig = LibDataConfig.getInstance().getProperties();
	private static final LibLogger logger = LibLogger.getLogger(TCA001ManagerAddLoan_P2P.class);

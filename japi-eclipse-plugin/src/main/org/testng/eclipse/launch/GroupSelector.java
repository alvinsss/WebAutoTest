...
public class GroupSelector extends MultiSelector {
  ...
  protected Collection<String> getValues(ILaunchConfiguration configuration) {
    ...
    try {
      ...
      Object[] types = TestSearchEngine.findTests(getCallback()
          .getLaunchConfigurationDialog(), projects, Filters.SINGLE_TEST);
  ...
  public void initializeFrom(ILaunchConfiguration configuration) {
    ...
    m_groupMap.clear();
    List<String> groupClassNames = ConfigurationHelper

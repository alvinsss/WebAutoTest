...
public class FailureTab extends AbstractTab {
  ...
  // if (ITestResult.SUCCESS != treeEntry.getStatus() && ITestResult.SKIP !=
  // treeEntry.getStatus()) {
  ...
  // // Horrible hack to remove all the SUCCESS nodes from our view. It's a hack
  // because they
  // // shouldn't have been added there in the first place. Without this hack,
  // this tab

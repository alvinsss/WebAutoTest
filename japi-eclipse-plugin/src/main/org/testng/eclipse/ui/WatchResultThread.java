...
public class WatchResultThread {
  ...
  public WatchResultThread(final String path,
      final IRemoteSuiteListener suiteListener,
      ...
      public void run() {
        ...
        while (m_watchResults) {
          ...
          if (t != timeStamp) {
            ...
            timeStamp = t;
            ResultXMLParser parser = new ResultXMLParser(suiteListener,
                testListener);
            try {
              parser.parse(path, new FileInputStream(f), false /*
                                                                * don't load
                                                                * classes
                                                                */);

...
public class BuildPathSupport {
  ...
  public static IClasspathEntry getTestNGLibraryEntry() {
    ...
    if (bundleBase != null) {
      IPath jarLocation = bundleBase.append(ResourceUtil
          .getString("TestNG.jdk15.library")); //$NON-NLS-1$
      IPath srcLocation = bundleBase.append(ResourceUtil
          .getString("TestNG.jdk15.sources")); //$NON-NLS-1$
  ...
  public static boolean projectContainsClasspathEntry(IJavaProject project,

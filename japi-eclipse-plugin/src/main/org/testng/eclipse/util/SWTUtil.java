...
public class SWTUtil {
  ...
  /**
   * @return a Text field that contains a path. The file system can be browsed
   *         by pressing the "Browse" button.
   */
  public static Text createPathBrowserText(final Composite container,
      String text, ModifyListener listener) {
   ...
   * @return a Label+Text.
   */
  public static Text createLabelText(Composite container, String text,

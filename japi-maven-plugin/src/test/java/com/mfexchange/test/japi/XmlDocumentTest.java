...
public class XmlDocumentTest {
    ...
    @Test
    public void testUpdateDependenciesAndSave() throws DocumentException, IOException {
        XmlDocument xmlDoc = new XmlDocument(getClass().getResourceAsStream("/pom1.xml"));
        List<String> jarPaths = new ArrayList<String>();
        jarPaths.add(".." + File.separator + "test" + File.separator + "mytest2-1.0.2.jar");
        xmlDoc.updateDependencies(jarPaths);
        String tmpfilePath = System.getProperty("java.io.tmpdir") + File.separator
                + "pom1-update-dependencies.xml";
        xmlDoc.dumpTo(tmpfilePath);
        assertTrue(compareEq(getClass().getResourceAsStream("/pom1-update-dependencies.xml"),
                new FileInputStream(new File(tmpfilePath))));
    }

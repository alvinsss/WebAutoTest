...
public class LibOrtherTypeLogin {
	WebDriver driver;
	private static String ManagerURL = null;
	private static final LibLogger logger = LibLogger.getLogger(LibOrtherTypeLogin.class);

	public LibOrtherTypeLogin(WebDriver driver) {
		this.driver = driver;
	}

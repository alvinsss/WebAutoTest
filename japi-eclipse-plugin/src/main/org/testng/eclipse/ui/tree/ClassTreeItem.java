 ...
 * and SuiteTreeItem) don't really own one RunInfo but several (one for each
 * test method underneath them). For this reason, the runInfo property of these
 * items is set to the first one they encounter, but as more updates come in,
 * the new RunInfo objects are passed directly to their update() method, insted
 * of using their own.
 * 

...
public class JUnit4Test2 {
  ...
  public void test_DoublesPair_of_PairDoubleDouble() {
    Pair<Double, Double> base = ObjectsPair.of(Double.valueOf(1.2d),
        Double.valueOf(2.5d));
    DoublesPair test = DoublesPair.of(base);
  ...
  public void test_DoublesPair_of_PairDoubleDouble_DoublesPair() {
    Pair<Double, Double> base = (Pair<Double, Double>) DoublesPair.of(1.2d,
        2.5d);
    DoublesPair test = DoublesPair.of(base);
    assertSame(base, test);
  }
  ...
  public void test_DoublesPair_ofNumbers_PairNumberNumber() {
    Pair<Integer, Long> base = ObjectsPair.of(Integer.valueOf(2),
        Long.valueOf(3L));
  ...
  // DoublesPair a = Pair.of(1.5d, 1.7d);
  // Pair<Double, Double> b = Pair.of(Double.valueOf(1.5d),
  // Double.valueOf(1.7d));
  ...
  // Pair<Double, Double> pair2 = new ObjectsPair<Double, Double>(first,
  // second);
